...
本仓库包含基于 OpenList 的二次开发修改。我不是 OpenList 原仓库作者，也不声明对上游项目的作者身份；原项目、商标、Logo 素材以及上游贡献归 OpenList Team 及其贡献者所有。

当前工作区主要新增和调整了服务器下载能力，包括独立的服务器下载权限、默认服务器下载目录设置、后端任务/API 支持以及相关测试。请将这些内容视为下游修改，并继续遵循上游 AGPL-3.0 许可证要求。
